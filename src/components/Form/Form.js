...
const agent = {
  firstName: {
    value: 'james',
    error: { empty: 'Нужно указать имя', wrong: 'Имя указано не верно' }
  },
  lastName: {
    value: 'bond',
    error: { empty: 'Нужно указать фамилию', wrong: 'Фамилия указана не верно' }
  },
  password: {
    value: '007',
    error: { empty: 'Нужно указать пароль', wrong: 'Пароль указан не верно' }
  }
};
        ...
        <form className="form">
          ...
          <p className="field">
            ...
            <input
              ...
              className="field-input field__input t-input-firstname"
            />
          ...
          <p className="field">
            ...
            <input
              ...
              value={lastName}
              onChange={this.changeInputValue}
              className="field-input field__input t-input-lastname"
            />
          ...
          <p className="field">
            ...
            <input
              ...
              value={password}
              onChange={this.changeInputValue}
              className="field-input field__input t-input-password"
            />
